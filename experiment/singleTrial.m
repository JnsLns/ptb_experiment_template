...
% Compute x,y,z starting position in millimeters (needed below to check
% pointer distance)
startPos_mm = [vaToMm(e.s.presArea_va(1)/2, e.s.spatialConfig), ...
               vaToMm(e.s.presArea_va(2)/2, e.s.spatialConfig), ...
               e.s.startPosZ_mm];
