% Draw stimuli to offscreen windows to later use them in the trial.
%
% In here you can do anything you like, probably based on what is defined
% in the trial list for the current trial. Access the current trial's
% parameters from the trial list like this:
%
