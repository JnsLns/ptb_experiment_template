...
a.s.gFit.yAxProp = 1;              % normalize data in yAxCol by maximum value (for each traj) in that column?
% IMPORTANT: Using this usually only makes sense when a.s.ivsCols.subtractOverallMean is enabled for
...
a.s.tCutoff = 0.9; % [seconds] Only effective when a.s.doApplyTimeCutoff == 1
