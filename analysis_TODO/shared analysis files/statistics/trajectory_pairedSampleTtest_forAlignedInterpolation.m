...
testDescription = 'worder_horz_ref_sptsAB';
...
% set ylim after adding stuff to axes? Can be left empty to not adjust ylim
% (it then spans the range of the input data)
setYLim = [0 .9];
...
for curTimestep = 1:minLen
    ...
    [h(curTimestep), p(curTimestep)] = ttest(x1,x2,'alpha',useAlpha);
