function trajViewerComparison(tr_1,rs_1,xAxLims_1,yAxLims_1,tr_2,rs_2,xAxLims_2,yAxLims_2,resCols,trajCols,sptStrings,yAxReverseFlags,showOnlyOne)
%
...
while 1
    ...
    if replot
        ...
        disp(['curvature                   : ', num2str(rs_2(curTraj,resCols.maxCurvature))])                
        elseif isFirstRun
            isFirstRun = 0;
        end
